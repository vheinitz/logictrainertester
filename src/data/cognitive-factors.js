...
export const cognitiveFactors = {
  ...
  KF004: { category:'auditive_wahrnehmung', de:'Akustisches Kurzzeitgedächtnis', ru:'', modules:['seq-zahlenfolgen','seq-wortreihe'] },
  ...
  KF011: { category:'auditive_wahrnehmung', de:'Auditives Kurzzeitgedächtnis', ru:'', modules:['seq-zahlenfolgen','lern-atlantis','seq-koffer-packen','wiss-raetsel','wiss-sachwissen','wiss-wortschatz'] },
  ...
  KF021: { category:'belastbarkeit_ausdauer', de:'Durchhaltevermögen', ru:'', modules:['seq-zahlenfolgen','lern-atlantis','wiss-sachwissen'] },
  ...
  KF032: { category:'aufmerksamkeit_konzentration', de:'Fokussierung', ru:'', modules:['seq-zahlenfolgen','seq-handbewegungen','sim-konzeptbildung'] },
  ...
  KF034: { category:'aufmerksamkeit_konzentration', de:'Fokussierung der Aufmerksamkeit', ru:'', modules:['seq-zahlenfolgen'] },
  ...
  KF037: { category:'sonstige', de:'Fähigkeit zur Rhythmisierung', ru:'', modules:['seq-zahlenfolgen'] },
  KF038: { category:'sonstige', de:'Fähigkeit zur mentalen Vervollständigung', ru:'', modules:['sim-gestaltschliessen'] },
  KF039: { category:'selbstregulation', de:'Geläufigkeit im Umgang mit Zahlen', ru:'', modules:['seq-zahlenfolgen'] },
  ...
  KF048: { category:'aufmerksamkeit_konzentration', de:'Konzentrationsfähigkeit', ru:'', modules:['seq-zahlenfolgen','seq-wortreihe','seq-handbewegungen','seq-koffer-packen','sim-suchbild','lern-atlantis','lern-memory','plan-muster','plan-sudoku'] },
  ...
  KF065: { category:'sonstige', de:'Seriation', ru:'', modules:['seq-zahlenfolgen','seq-koffer-packen','plan-geschichten'] },
  KF066: { category:'sonstige', de:'Seriation (Reihenfolge einhalten)', ru:'', modules:['seq-zahlenfolgen'] },
  ...
  KF086: { category:'visuelle_wahrnehmung', de:'Visuelles Kurzzeitgedächtnis', ru:'', modules:['seq-handbewegungen','lern-atlantis','lern-memory','sim-gesichter'] },
