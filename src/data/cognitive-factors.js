...
export const cognitiveFactors = {
  ...
  KF003: { category:'auditive_wahrnehmung', de:'Akustisch-motorisches Gedächtnis', ru:'', modules:['seq-rhythmus','seq-wortreihe-audio'] },
  KF004: { category:'auditive_wahrnehmung', de:'Akustisches Kurzzeitgedächtnis', ru:'', modules:['seq-zahlenfolgen-audio','seq-wortreihe-audio'] },
  ...
  KF010: { category:'auditive_wahrnehmung', de:'Auditive Wahrnehmung', ru:'', modules:['seq-rhythmus','seq-zahlenfolgen-audio','seq-wortreihe-audio'] },
  KF011: { category:'auditive_wahrnehmung', de:'Auditives Kurzzeitgedächtnis', ru:'', modules:['seq-zahlenfolgen-audio','seq-wortreihe-audio','seq-koffer-packen-audio'] },
  ...
  KF042: { category:'auditive_wahrnehmung', de:'Intermodalität: Hören-Sehen-Bewegen', ru:'', modules:['seq-rhythmus'] },
  ...
  KF048: { category:'aufmerksamkeit_konzentration', de:'Konzentrationsfähigkeit', ru:'', modules:['seq-zahlenfolgen','seq-zahlenfolgen-audio','seq-wortreihe','seq-handbewegungen','seq-koffer-packen','sim-suchbild','lern-atlantis','lern-memory','plan-muster','plan-sudoku','seq-wortreihe-audio','seq-koffer-packen-audio'] },
  ...
  KF053: { category:'exekutive_funktionen', de:'Merkstrategien', ru:'', modules:['lern-symbole','lern-memory','seq-koffer-packen','lern-atlantis','seq-koffer-packen-audio'] },
  ...
  KF064: { category:'gedaechtnis', de:'Sequentielles Gedächtnis', ru:'', modules:['plan-zaubertricks','seq-wortreihe','seq-koffer-packen','seq-wortreihe-audio','seq-koffer-packen-audio'] },
  KF065: { category:'sonstige', de:'Seriation', ru:'', modules:['seq-zahlenfolgen','seq-zahlenfolgen-audio','seq-koffer-packen','plan-geschichten','seq-koffer-packen-audio'] },
  ...
  KF073: { category:'belastbarkeit_ausdauer', de:'Stressresistenz', ru:'', modules:['lern-atlantis','seq-wortreihe','seq-wortreihe-audio'] },
  ...
  KF086: { category:'visuelle_wahrnehmung', de:'Visuelles Kurzzeitgedächtnis', ru:'', modules:['seq-zahlenfolgen','seq-wortreihe','seq-koffer-packen','seq-handbewegungen','lern-atlantis','lern-memory','sim-gesichter'] },
  KF087: { category:'visuelle_wahrnehmung', de:'Visuelles und auditives Kurzzeitgedächtnis', ru:'', modules:[] },
