...
export const performanceModel = {
  ...
  // ===== SEQUENTIAL / Gsm =====
  'seq-zahlenfolgen': {
    scale:'sequential', subtestRef:'Zahlen nachsprechen',
    whatItMeasures:{de:'Auditives Kurzzeitgedächtnis, Konzentrationsfähigkeit, Seriation',ru:'Слуховая кратковременная память, концентрация, сериация'},
